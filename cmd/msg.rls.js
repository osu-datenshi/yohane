...
module.exports = {
    ...
    run: async (client, message, args) => {
		...
		.setAuthor("OSU! ROLES", "https://raw.githubusercontent.com/osu-datenshi/assets/master/logo.png", "https://datenshi.troke.id")
		.setColor(hex)
		.setDescription(
            "In this section, the osu! roles is for the our osu! private server, before you can access the all of <@&849976215355654196> channels you need 1 roles for this, **please read below!!**\n\n<@&794156391342145586> - This is our osu! system maintainers, contact them for any inquiries\n\n<@&794913317322883073> - This group it's managing all of the osu! community section\n\n<@&794852916305330196> - This group is watching your chat in osu!\n\n<@&794180047882813440> - Any problem with beatmap ranking procedure goes to this groups!\n\n<@&799260131430629376> - Carefull, they are watching your osu scores!\n\n<@&818101962859085855> - **You must link** your osu!Datenshi account with your discord account using our bot! [click here](https://osu.troke.id/discordtokens) for the tutorial and **you will have an access to all of the discord channels**\n\n<@&794909882724646912> - This roles it's only for people who already making a liveplay for proofing that they are not using any illegal hacks when playing on Datenshi, [click here](https://osu.troke.id/doc/liveplay) if you want to get this roles")
		...
		.setAuthor("MINECRAFT ROLES", "https://raw.githubusercontent.com/osu-datenshi/assets/master/logo.png", "https://datenshi.troke.id")
		.setColor(hex)
		.setDescription(
