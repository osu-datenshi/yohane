    ...
    client.on("message", message => {
        if (message.content.startsWith(config.bot.prefix + "faq")) {
            ...
            if (msg.toLowerCase() == "email") {
                ...
                .addField("Troubleshooting", "Jika kalian mengalami masalah pada koneksi switcher silahkan menggunakan [cara manual](https://osu.troke.id/doc/install_certificate_and_hosts_manually)")
