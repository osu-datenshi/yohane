    ...
    client.on("message", message => {
        if (message.content.startsWith(config.bot.prefix + "faq")) {
            ...
            if (msg.toLowerCase() == "email") {
                ...
                .addField("**Description**", "If you new in this server and still waiting email verification\nWe dont send any verification email for verified your ACCOUNT!\n**YOU JUST NEED TO LOGIN INTO THE GAME AND YOU ARE VERIFIED SUCCESSFULL!!**")
            } else if (msg.toLowerCase() == "banned") {
                embed.setTitle("Banned/Restricted")
                .addField("**Description**", "Are you got banned or Restricted? Please Read Our Rules, and if you want to appeal, read [this](https://datenshi.xyz/doc/liveplay)")
                ...
                .addField("**Description**", "You must update your server switcher or try to uninstalling the cert and install by manually, see [doc](https://datenshi.xyz/index.php?p=16&id=12)")
            } else if (msg.toLowerCase() == "hosts") {
                embed.setTitle("Hosts File Error")
                .addField("**Description**", "You must update your server swithcer or try to remove your hosts file and add it by manually, see [doc](https://datenshi.xyz/index.php?p=16&id=12)")
	        } else if (msg.toLowerCase() == "verified") {
		        embed.setTitle("Verified Tenshi/Little Tenshi")
		        .addField("**Description**", "You need to know about these roles! Please Read!\n<@&707312785146773515> This roles is for users who already upload their liveplay for proofing that they dont use any illegal program, users who have this role are totally legit! How to get it? [Click here](https://datenshi.xyz/doc/liveplay)\n<@&707470790169198643> This roles is **only** to get full access our discord channel and not verified your account for new users! You just need to verify your account by login into the game! see <#742317817528844308> for how to get this roles!")
	        } else if (msg.toLowerCase() == "map") {
		        embed.setTitle("Beatmaps")
		        .addField("**Description**", "Please read, if you want to request your map to be ranked, you must read our Ranking Criteria [Indonesian Rules](https://datenshi.xyz/index.php?p=16&id=2) & [English Rules](https://datenshi.xyz/index.php?p=16&id=20)")
		        .addField("**How to request?**", "[Submit Map](https://datenshi.xyz/beatmaps/rank_request), if you are <@&699280489164308541> you can directly access our <#727423092397441094> channel")
