...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        var user = await fetch(`${client.config.bot.domain}/api/v1/fokabotMessage?k=${client.config.bot.banchokey}&to=%23admin&msg=!unrestrict+${msg}`).then(response => response.json());
