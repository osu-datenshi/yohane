...
module.exports = {
    ...
    run: async (client, message, args) => {
		...
		const bannerWelcome = new (Discord.MessageEmbed)().setColor(hex).setImage("https://cdn.discordapp.com/attachments/728581754398572546/849187512689360906/DATENSHI_BANNER.png")
		...
		const bannerosu = new (Discord.MessageEmbed)().setColor(hex).setImage("https://cdn.discordapp.com/attachments/728581754398572546/849194673507663933/osu.png")

		const osu = new Discord.MessageEmbed()
		.setAuthor("osu! server", "https://raw.githubusercontent.com/osu-datenshi/assets/master/logo.png", "https://osu.datenshi.pw")
		.setColor(hex)
		...
		.addField("Connecting Guide", "You can go to the [website](https://osu.datenshi.pw/doc/1) for the tutorial")
		...
		.setAuthor("Minecraft server", "https://raw.githubusercontent.com/osu-datenshi/assets/master/logo.png", "https://datenshi.pw")
		.setColor(hex)
		.setDescription("If you are Minecraft player, please read this\n")
		.addField("Server IP", "`play.datenshi.pw`")
		.addField("Version", "1.8-latest")
		...
		.setAuthor("LINKS", "https://raw.githubusercontent.com/osu-datenshi/assets/master/logo.png", "https://datenshi.pw")
		.setColor(hex)
		.setDescription("- [Website](https://datenshi.pw)\n- [osu! Website](https://osu.datenshi.pw)\n- [osu! Documentation](https://osu.datenshi.pw/doc)\n- [osu! Register](https://osu.datenshi.pw/register)\n- [GitHub](https://github.com/osu-datenshi)\n- [GitLab](https://gitlab.com/osudatenshi)\n- [Facebook Page](https://www.facebook.com/datenshicommunity)\n- [Facebook Group](https://www.facebok.com/groups/osu.datenshi)\n- [Youtube](https://www.youtube.com/channel/UCKwyGpWAD17sVpKwlRDhisw)\n- [Donate](https://datenshi.pw/donations)")
